...
def beeswarm(base_values, shap_values, features, feature_names, max_display=10, order=Explanation.abs.mean(0),
             clustering=None, cluster_threshold=0.5, color=None,
             axis_color="#333333", alpha=1, show=True, log_scale=False,
             color_bar=True, plot_size="auto", color_bar_label="Feature value"):
    ...
    if False and str(type(shap_values)).endswith("Explanation'>"):
